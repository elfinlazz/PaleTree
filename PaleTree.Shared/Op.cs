...
namespace PaleTree.Shared
{
	public static class Op
	{
		...
		public const int CZ_DUMMYPC_SKILL_POS = 0xE20; // Size: 26
		public const int CZ_NGS = 0xE21; // Size: 0
		public const int CZ_PARTY_MEMBER_SKILL_USE = 0xE22; // Size: 0
		public const int CZ_PARTY_MEMBER_SKILL_ACCEPT = 0xE23; // Size: 22
		public const int CZ_SYSTEM_LOG_TO_SERVER = 0xE24; // Size: 1099
		public const int CZ_CHECK_PING = 0xE25; // Size: 10
		public const int CZ_CANCEL_INDUN_MATCHING = 0xE26; // Size: 10
		public const int CZ_REQ_GM_ORDER = 0xE27; // Size: 202
